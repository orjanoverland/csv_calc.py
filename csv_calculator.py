...
# New functionality
def highest_sales_product(sales_data: List[Dict[str, str]]) -> Dict[str,float]:

    total_sales = calculate_total_sales(sales_data)
        
    product_with_highest_sales = max(total_sales, key=total_sales.get)
    
    return {
        product_with_highest_sales: total_sales[product_with_highest_sales]
    }
...
# New functionality
highest_sales = highest_sales_product(sales_data)
display_results(highest_sales, "Product with highest sale value")